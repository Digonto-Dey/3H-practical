...
plot(years, fires, main="LS Model Fit 
line", col = "red")
abline( lm ( fires ~ years ), col= 4)

n=5
p=1
h = floor((n/2)+(p+1)/2) # of obs. Each group 

## Create a function to collect median squre of errors
...
e10 <- med.er.sq(years[c(3,4,5)], fires[c(3,4,5)])##10.line
